...
public class Server implements Runnable {
    ...
    public Server(ServerCallBack serverCallBack, NameserverCallBack nameserverCallBack,
        ...
        this.griffin = new Griffin(taskFactory, serverCallBack,
                                   nameserverInfo, this.serverInfo,
                                   infoParser);
            ...
            while (!Thread.currentThread().isInterrupted()) {
                ...
                if (firstInput instanceof String) {
                    ...
                    if (possibleStopCommand.equals(STOP_SERVER_COMMAND)) {
                        this.serverCallBack.commandRecieved(prevComm.getDateTime(),
                                                            prevComm.getRemoteAddr(), prevComm.getLocalAddr(),
                                                            STOP_SERVER_COMMAND);
